    ...
    <div className="bg-white">
      ...
      <section className="container mx-auto px-4 py-12">
        <h2 className="text-2xl font-bold text-center mb-4">
          Top Career and Soft Skills Counseling Services
        </h2>
        <p className="text-center text-lg mb-8">
          Talk to a certified counselor for career and soft skills improvement
          in just a few clicks. No matter what stage you're at in your career,
          our counselors can help you navigate through challenges and reach your
          goals.
        </p>
        <div className="flex justify-center">
          <img
            src="/path/to/services-illustration.png"
            alt="Services Illustration"
            className="mx-auto mt-4"
          />
        </div>
        <p className="text-center text-lg mt-8">
          We offer personalized counseling sessions to help you improve your
          skills, boost your confidence, and achieve your professional goals.
        </p>
      </section>
      ...
      <section className="bg-gray-100 py-12">
        ...
        <p className="text-center text-lg mb-8">
          ...
          elementum turpis hac tellus libero accumsan.
        </p>
