...
const NavBar =  () => {
    return         <nav className="flex items-center justify-between p-5 bg-purple-200 text-black shadow-lg">
    ...
    <ul className="flex items-center space-x-6">
        ...
        <li><Link to="/contact-us" className="hover:text-purple-700">Contact</Link></li>
    </ul>
    <div>
        <Button color="green" ripple={true}>Login</Button>
    </div>
</nav>
}
